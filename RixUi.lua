...
local ListB = {"No Quest", "Quest"}
    BoneCakeMode = "No Quest"
    
    local methodBoneCake = Tabs.Sf:AddDropdown("DropdownmethodBoneCake", {
    Title = "Method Bone & Cake Prince",
    Values = ListB,
    Multi = false,
    Default = BoneFMode,
})
methodBoneCake:SetValue("No Quest")
methodBoneCake:OnChanged(function(Value)
    BoneCakeMode = Value
				end)
        ...
        pcall(function()
          ...
          if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position - v.Position).Magnitude >= 10 then
            Tween(v.HumanoidRootPart.CFrame * Pos)
				...
				local ToggleBone = Tabs.At:AddToggle("ToggleBone", {
...
spawn(function()
    while wait() do 
        if BoneCakeMode == "No Quest" and _G.AutoBone and World3 then
            pcall(function()
...
spawn(function()
    while wait() do
        if BoneCakeMode == "Quest" and _G.AutoBone and World3 then
            pcall(function()
				...
				local ToggleCake = Tabs.At:AddToggle("ToggleCake", {
...
spawn(function()
    while wait() do
        if BonCakeMode == "No Quest" and _G.CakePrince and World3 then
...
task.spawn(function()
    while wait() do
        if CakeFMode == "Quest" and _G.CakePrince and World3 then
            pcall(function()
