...
function CheckQuest() 
    ...
    if World1 then
        if MyLevel == 1 or Lv <= 9 or SelectMonster == "Bandit" then 
Ms = "Bandit"
...
spawn(function()
  while wait(0.000000001) do -- Tăng tốc độ tấn công bằng cách giảm thời gian chờ
    module:attack()
  end
end)
