...
xpcall(function()
	if not isfolder("RixHub/ID/"..game.GameId) then
		if syn then
			makefolder("RixHub/ID/"..game.GameId)
			writefile("RixHub/ID/"..game.GameId.."/"..game.Players.LocalPlayer.Name..".lua", game:GetService("HttpService"):JSONEncode(SettingsGameData));
		else
			makefolder("RixHub")
			makefolder("RixHub/ID")
			makefolder("RixHub/ID/"..game.GameId)
			writefile("RixHub/ID/"..game.GameId.."/"..game.Players.LocalPlayer.Name..".lua", game:GetService("HttpService"):JSONEncode(SettingsGameData));
		end
	end
	SettingsGameData = game:GetService("HttpService"):JSONDecode(readfile("RixHub/ID/"..game.GameId.."/"..game.Players.LocalPlayer.Name..".lua"));
end,function()
end)
...
local ToggleRandomFruit = Tabs.Shop:AddToggle("ToggleRandomFruit", {Title = "Random Fruit",Description = "", Default = false })
...
local ToggleSwordLengend = Tabs.Shop:AddToggle("ToggleSwordLengend", {Title = "Buy Legendary Sword",Description = "",Default = false })
...
local ToggleUpgrade = Tabs.Shop:AddToggle("ToggleUpgrade", {Title = "Buy Gear", Description = "", Default = false })
...
Tabs.Shop:AddButton({
    Title = "Buy Draco (Only Third Sea)",
    Description = "",
    Callback = function()
